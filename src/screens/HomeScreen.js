      ...
      >
        ...
        {analyzing ? (
          ...
          <View style={styles.captureArea}>
            ...
            {/* Multi-View — reads as a real button with action-verb label + subtitle */}
            <TouchableOpacity
            ...
            >
              ...
              <View style={styles.multiViewBtnTextWrap}>
                <Text style={styles.multiViewBtnText}>Take Multi-View Images</Text>
                <Text style={styles.multiViewBtnSub}>3 angles · better accuracy</Text>
              </View>
            </TouchableOpacity>
        ...
        {/* Tutorial replay — visible chip instead of invisible italic ghost */}
        {!analyzing && (
          <View style={styles.tutorialWrap}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.tutorialChipIcon}>🎬</Text>
              <Text style={styles.tutorialChipText}>Watch Tutorial Again</Text>
            </TouchableOpacity>
          </View>
        )}
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  // Multi-View — reads as a real button, subordinate to Take Photo
  multiViewBtn: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
    ...
    width: "88%", // slight inset visually subordinates it to Take Photo
  },
  multiViewBtnIcon: {
    fontSize: 20,
  },
  multiViewBtnTextWrap: {
  ...
  // Tutorial replay — visible chip with real contrast
  tutorialWrap: {
    alignItems: "center",
    marginTop: 28,
  },
